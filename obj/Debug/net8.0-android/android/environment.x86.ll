...
@dso_cache = dso_local local_unnamed_addr global [36 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2856463942, ; hash 0xaa422e46, from name: libuiohook
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2958732738, ; hash 0xb05aadc2, from name: uiohook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libuiohook.so
		ptr null; void* handle (0x0)
	}, ; 23
	%struct.DSOCacheEntry {
		i64 2998887876, ; hash 0xb2bf65c4, from name: libuiohook.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libuiohook.so
		ptr null; void* handle (0x0)
	}, ; 24
	...
	%struct.DSOCacheEntry {
		i64 4176136112, ; hash 0xf8eac7b0, from name: uiohook.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libuiohook.so
		ptr null; void* handle (0x0)
	} ; 35
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [316 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
