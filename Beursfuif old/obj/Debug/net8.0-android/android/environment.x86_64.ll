...
@dso_cache = dso_local local_unnamed_addr global [36 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 4384763842249552042, ; hash 0x3cd9cf7ba942f0aa, from name: libuiohook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libuiohook.so
		ptr null; void* handle (0x0)
	}, ; 3
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 12327710973021893529, ; hash 0xab14d3d0a0a7b399, from name: libuiohook.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libuiohook.so
		ptr null; void* handle (0x0)
	}, ; 21
	%struct.DSOCacheEntry {
		i64 13963192618563852394, ; hash 0xc1c739b4d7dad86a, from name: uiohook.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libuiohook.so
		ptr null; void* handle (0x0)
	}, ; 22
	...
	%struct.DSOCacheEntry {
		i64 15962245850893803655, ; hash 0xdd854a079ffa6087, from name: uiohook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libuiohook.so
		ptr null; void* handle (0x0)
	}, ; 26
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [323 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
...
@.env.3 = private unnamed_addr constant [37 x i8] c"61754fa1-2056-409c-b366-fe6264c9c528\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.beursfuif\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [14 x i8] c"libuiohook.so\00", align 1
